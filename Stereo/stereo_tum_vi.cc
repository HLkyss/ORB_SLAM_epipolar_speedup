...
//    ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::STEREO,true);
    ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::STEREO,false);// todo 关闭可视化
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            // 修改双目视野
//            int crop = 110;
//            cv::Rect roi_left(0, 0, crop, imLeft.rows);
//            cv::Rect roi_right(imRight.cols - crop, 0, crop, imRight.rows);
//            imLeft(roi_left) = cv::Scalar(0);
//            imLeft(roi_right) = cv::Scalar(0);
//            imRight(roi_left) = cv::Scalar(0);
//            imRight(roi_right) = cv::Scalar(0);

// 双目固定400
//            int add=20;
//            cv::Rect roi_left_add(120-add, 0, add, imLeft.rows);
//            cv::Rect roi_left_crop1(0, 0, 120-add, imLeft.rows);
//            cv::Rect roi_left_crop2(520, 0, 120, imLeft.rows);
//            cv::Rect roi_right_add(520, 0, add, imRight.rows);
//            cv::Rect roi_right_crop1(0, 0, 120, imRight.rows);
//            cv::Rect roi_right_crop2(520+add, 0, 120-add, imRight.rows);
//            imLeft(roi_left_crop1) = cv::Scalar(0);
//            imLeft(roi_left_crop2) = cv::Scalar(0);
//            imRight(roi_right_crop1) = cv::Scalar(0);
//            imRight(roi_right_crop2) = cv::Scalar(0);

// 双目固定200
//            int add=200;
//            cv::Rect roi_left_add(220-add, 0, add, imLeft.rows);
//            cv::Rect roi_left_crop1(0, 0, 220-add, imLeft.rows);
//            cv::Rect roi_left_crop2(420, 0, 220, imLeft.rows);
//            cv::Rect roi_right_add(420, 0, add, imRight.rows);
//            cv::Rect roi_right_crop1(0, 0, 220, imRight.rows);
//            cv::Rect roi_right_crop2(420+add, 0, 220-add, imRight.rows);
//            imLeft(roi_left_crop1) = cv::Scalar(0);
//            imLeft(roi_left_crop2) = cv::Scalar(0);
//            imRight(roi_right_crop1) = cv::Scalar(0);
//            imRight(roi_right_crop2) = cv::Scalar(0);
            ...
            // 双目固定300
//            int add=160;
//            cv::Rect roi_left_add(170-add, 0, add, imLeft.rows);
//            cv::Rect roi_left_crop1(0, 0, 170-add, imLeft.rows);
//            cv::Rect roi_left_crop2(470, 0, 170, imLeft.rows);
//            cv::Rect roi_right_add(470, 0, add, imRight.rows);
//            cv::Rect roi_right_crop1(0, 0, 170, imRight.rows);
//            cv::Rect roi_right_crop2(470+add, 0, 170-add, imRight.rows);
//            imLeft(roi_left_crop1) = cv::Scalar(0);
//            imLeft(roi_left_crop2) = cv::Scalar(0);
//            imRight(roi_right_crop1) = cv::Scalar(0);
//            imRight(roi_right_crop2) = cv::Scalar(0);
